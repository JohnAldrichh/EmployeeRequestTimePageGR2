package com.mycompany.employeerequesttimeoffpage;
...
public class EmployeeRequestTimeOffPage extends JFrame {
    
     private JLabel Title;
     private JLabel EMPINFOTitle;
     private JLabel Name;
     private JTextField NameLABEL;
     private JLabel DPT;
     private JTextField DPTLABEL;      
     private JLabel TOR;
     private JTextField TORLABEL;        
     private JLabel DAF;
     private JTextField DAFLABEL;        
     private JLabel to;
     private JTextField toLABEL;        
     private JLabel TAR;
     private JTextField TARLABEL;
     private JCheckBox VCN;
     private JCheckBox ML;
     private JCheckBox JD;
     private JCheckBox PL;
     private JCheckBox FR;
     private JCheckBox TV;
     private JCheckBox BMT;
     private JCheckBox TOWP;
     private JLabel RFTR;
     private JTextArea RFTRAREA;        
     private JLabel IRAE;        
     private JLabel ES;
     private JTextField ESLABEL;
     private JLabel Date;
     private JTextField DateLABEL;
    
     
  public  EmployeeRequestTimeOffPage() 
  {           
  ...
  con.add(TOWP);  
   ...
   setVisible(true);
             ...
             public static void main(String[]args){
                new EmployeeRequestTimeOffPage();
             }
}